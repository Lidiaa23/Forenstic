				...
				<div class="col">
					<div class="card mx-auto">
						...
						<div class="card-header">
							<h4>
								<i class="fas fa-laptop"></i> Agregar evidencia digital al caso [${idCaso}] ${nombreCaso}
							</h4>
						</div>
						
						<div class="card-body">

							<form id="agregarEvidenciaAlCasoForm"
								...
								<input type="hidden" name="idCaso" value="${idCaso}">
									...
									<div class="row justify-content-md-center">
										<div class="col-7">
											<label for="#" class="form-label">Selecciona el dispositivo al que añadirle esta evidencia digital</label>   
											<select name="idDispositivo" class="form-control" data-live-search="true">
												
												<option value="-1">Sin dispositivo asociado</option>
												<c:forEach var="dispositivo" items="${listaDispositivosDeCaso}" varStatus="status">										
