				...
				<div class="col">
					<div class="card mx-auto">
						...
						<c:choose>
							<c:when test="${fn:length(listaMisDispositivosSinCadenaCustodia) > 0}">
								...
								<form id="agregarCadenaCustodiaForm"
									...
									<div class="row justify-content-md-center">
										<div class="col-7">
											<label for="#" class="form-label">Selecciona el dispositivo al que añadirle esta cadena de custodia</label>   
							...
							<c:otherwise>
								<dd class="col-sm-9">Actualmente aún no dispones de dispositivos asignados sin cadena de custodia, por lo que no es posible añadir una.</dd>
							</c:otherwise>
						</c:choose>
